...
function draw() {
  ...
  textFont('Courier');
  textSize(30);
  text("Best Scorer: " + Math.floor((Math.log(getFitness(birds[indexOfBestFitness].posX, birds[indexOfBestFitness].posY, birds[indexOfBestFitness].hasTouchedObstacle, birds[indexOfBestFitness].hasTouchedGoal))), 10, 40)/1000);
  textSize(12);
  textSize(20);
